...
CONFIG_DEFAULTS = {
    ...
    # :class:`core.formatter.SwaggerFormat`. These formats are in
...
class Spec(object):
    ...
    def is_equal(self, other):
        ...
        # If self and other are of the same type but not pointing to the same memory location
        # then we're going to inspect
        # all the attributes.
        for attr_name in set(chain(iterkeys(self.__dict__), iterkeys(other.__dict__))):
            # Some attributes do not define equality methods.
            # As those attributes are defined internally only we do not expect that users of the library
            # are modifying them.
            if attr_name in {
            ...
            # In case of fully dereferenced specs _deref_flattened_spec (and consequently _internal_spec_dict)
            # will contain
    ...
    def __getstate__(self):
        state = {
            ...
            if k not in (
                ...
                # Check core.model._to_pickleable_representation for details.
                'definitions',
            )
        }
        ...
        state['__core_version__'] = _version
        return state

    def __setstate__(self, state):
        state_version = state.pop('__core_version__')
    ...
    def get_op_for_request(self, http_method, path_pattern):
        ...
        :rtype: :class:`core.operation.Operation`
        """
    ...
    def register_format(self, user_defined_format):
        ...
        :type user_defined_format:
            :class:`core.formatter.SwaggerFormat`
        """
    ...
    def get_format(self, name):
        ...
        :rtype: :class:`core.formatter.SwaggerFormat`
        """
