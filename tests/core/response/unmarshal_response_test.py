...
def test_no_content(empty_swagger_spec):
    ...
    with patch('easyesi.core.response.get_response_spec') as m:
...
def test_msgpack_content(empty_swagger_spec, response_spec):
    ...
    with patch(
        'easyesi.core.response.get_response_spec',
...
def test_skips_validation(empty_swagger_spec, response_spec):
    ...
    with patch('easyesi.core.response.validate_schema_object') as val_schem:
        with patch('easyesi.core.response.get_response_spec') as get_resp:
