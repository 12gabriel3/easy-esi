...
from core.security_requirement import SecurityRequirement
...
class Operation(object):
    ...
    def __repr__(self):
        # type: () -> str
        rep = u"{self.__class__.__name__}({self.operation_id})".format(self=self)
        if PY2:
            return rep.encode('ascii', 'backslashreplace')
        else:
            return rep
