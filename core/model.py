...
class ModelMeta(abc.ABCMeta):
    ...
    def __subclasscheck__(cls, subclass):
        def _is_same_model(m1, m2):
            ...
            """
            try:
                return m1._json_reference == m2._json_reference \
                    and m1._swagger_spec.origin_url == m2._swagger_spec.origin_url
        ...
        if not is_subclass and subclass:
            try:
                ...
                # Attribute error is possible if the passed subclass is not a `core.model.Model` class or subclass
                pass
...
class Model(object):
    ...
    .. attribute:: _swagger_spec
        ...
        :class:`core.spec.Spec` the model was created from.
    ...
    .. attribute:: _properties
        ...
        :func:`core.schema.collapsed_properties`.
...
def is_model(swagger_spec, schema_object_spec):
    """
    :param swagger_spec: :class:`core.spec.Spec`
...
def _to_pickleable_representation(model_name, model_type):
    ...
    NOTE:   This API should not be considered a public API and is meant
            only to be used by core.spec.Spec.__getstate__ .
    """
    return {
