...
The operation should also take care of converting types
 accordingly to the defined :class:`core.formatter.SwaggerFormat`s.
"""
import typing
import warnings
...
from easyesi.core.schema import collapsed_required
from easyesi.core.schema import get_type_from_schema
...
if getattr(typing, 'TYPE_CHECKING', False):
    ...
    from easyesi.core._compat_typing import NoReturn
    from easyesi.core._compat_typing import UnmarshalingMethod
    from easyesi.core.model import Model  # pragma: no cover
...
def _get_unmarshaling_method(swagger_spec, object_schema, is_nullable=True):
    ...
    if object_type == 'array':
        ...
        # TODO: Type file is not a valid type. It is present to support parameter unmarshaling (move to core.param)  # noqa: E501
...
def _unmarshal_object(
    ...
    :param swagger_spec: Spec object
    :param model_type: Type of the return value (:class:`dict` or a subclass of :class:`core.model.Model`)
    ...
    :param discriminator_property: Discriminator property name. It will be `None` if
            the schema is not a polymorphic schema
    :param possible_discriminated_type_name_to_model: Mapping of the possible dereferenced
            Model names and Model instances.
...
def _unmarshaling_method_primitive_type(swagger_spec, object_schema):
    ...
    The method will be responsible for the identification of the eventual :class:`core.formatter.SwaggerFormat`
