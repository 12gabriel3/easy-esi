...
if getattr(typing, 'TYPE_CHECKING', False):
    ...
    from easyesi.core._compat_typing import MarshalingMethod
...
def _marshaling_method_file(swagger_spec, object_schema):
    # type: (Spec, JSONDict) -> MarshalingMethod
    # TODO: Type file is not a valid type. It is present to support parameter marshaling (move to core.param)  # noqa: E501
    return _no_op_marshaling
...
def _marshal_object(
    ...
    :param discriminator_property: Discriminator property name.
            It will be `None` if the schema is not a polymorphic schema
    :param possible_discriminated_type_name_to_model: Mapping of the possible
            dereferenced Model names and Model instances.
